...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"全民时代卡片","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 11:
/*!***************************************!*\
  !*** E:/Uni/edu/common/http/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(global, uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config2 = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function apiRequest(options) {
  return new Promise(function (resolve, reject) {
    ...
    var request = Object.assign({}, _config2.default, options);
    // 已初始化、开始请求
    uni.request(request);
  });
}
...
/**
   ...
   */
function apiurl(api) {
  return _config2.default.host + api;
}

function clientUrl(page) {
  return _config2.default.host + 'h5/#/' + page;
}

function post() {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
function auth() {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return new Promise(function (resolve, reject) {
    ...
    apiRequest(options).then(function (res) {
      resolve(res);
    }).catch(function (err) {
      reject(err);
    });
...

{
  ...
  image: image,
  file: file,
  clientUrl: clientUrl };exports.default = _default;
...
/***/ 12:
/*!****************************************!*\
  !*** E:/Uni/edu/common/http/config.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  responseType: "text" };exports.default = _default;

/***/ }),

/***/ 13:
/*!****************************************!*\
  !*** E:/Uni/edu/common/store/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var actions = _interopRequireWildcard(__webpack_require__(/*! @/common/store/actions.js */ 15));
var getters = _interopRequireWildcard(__webpack_require__(/*! @/common/store/getters.js */ 16));
var _mutations = _interopRequireDefault(__webpack_require__(/*! @/common/store/mutations.js */ 17));function _getRequireWildcardCache() {if (typeof WeakMap !== "function") return null;var cache = new WeakMap();_getRequireWildcardCache = function _getRequireWildcardCache() {return cache;};return cache;}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;}if (obj === null || typeof obj !== "object" && typeof obj !== "function") {return { default: obj };}var cache = _getRequireWildcardCache();if (cache && cache.has(obj)) {return cache.get(obj);}var newObj = {};var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor;for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null;if (desc && (desc.get || desc.set)) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}newObj.default = obj;if (cache) {cache.set(obj, newObj);}return newObj;}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 133:
/*!*****************************************!*\
  !*** E:/Uni/edu/common/graceChecker.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ 15:
/*!******************************************!*\
  !*** E:/Uni/edu/common/store/actions.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(global) {Object.defineProperty(exports, "__esModule", { value: true });exports.loadSystemInfo = exports.reloadUserInfo = exports.loadUserInfo = void 0;var loadUserInfo = function loadUserInfo(_ref, userInfo) {var commit = _ref.commit,state = _ref.state;
  return new Promise(function (resolve, reject) {
    ...
    {
      global.http.auth("user.info").then(function (res) {
        if (res.errcode === 0) {
...
},reloadUserInfo = function reloadUserInfo(_ref2, userInfo) {var commit = _ref2.commit,state = _ref2.state;
  return new Promise(function (resolve, reject) {
    global.http.auth("user.info").then(function (res) {
      if (res.errcode === 0) {
        commit('setUserInfo', res.data.data);
...
},loadSystemInfo = function loadSystemInfo(_ref3, systemInfo) {var commit = _ref3.commit,state = _ref3.state;
  return new Promise(function (resolve, reject) {
    if (state.systemInfo) {
      setTimeout(function () {
    ...
    {
      global.http.auth("system.info").then(function (res) {
        if (res.errcode === 0) {
...
};exports.loadSystemInfo = loadSystemInfo;exports.reloadUserInfo = reloadUserInfo;exports.loadUserInfo = loadUserInfo;
...
/***/ 16:
/*!******************************************!*\
  !*** E:/Uni/edu/common/store/getters.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.systemInfo = exports.userInfo = void 0;var userInfo = function userInfo(state) {
  return state.userInfo;
},systemInfo = function systemInfo(state) {
  return state.systemInfo;
};exports.systemInfo = systemInfo;exports.userInfo = userInfo;

/***/ }),

/***/ 17:
/*!********************************************!*\
  !*** E:/Uni/edu/common/store/mutations.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var mutations = {
  setUserInfo: function setUserInfo(states, userInfo) {
    states.userInfo = userInfo;
  },
  setSystemInfo: function setSystemInfo(states, systemInfo) {
    states.systemInfo = systemInfo;
  } };var _default =
...
/***/ 18:
/*!**********************************************!*\
  !*** E:/Uni/edu/common/js_sdk/ican-H5Api.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
